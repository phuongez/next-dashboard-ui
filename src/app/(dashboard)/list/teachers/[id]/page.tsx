          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 w-full rounded-md flex gap-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%] ">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">Học sinh tham gia</span>
              </div>
            </div>
            {/* Card */}
            <div className="bg-white p-4 w-full rounded-md flex gap-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%] ">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">Nhánh</span>
              </div>
            </div>
            {/* Card */}
            <div className="bg-white p-4 w-full rounded-md flex gap-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%] ">
